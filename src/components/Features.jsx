    ...
    <div className=" relative size-full">
      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
        <div>
          ...
          {description && (
            <p className="mt-3 max-w-64 text-xs md:-base">{description}</p>
          )}
        </div>
      </div>
    </div>
    ...
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="text-blue-50 opacity-50 max-w-md font-circular-web text-lg">
            Immerse yourself in a rich and ever-expanding <br /> ecosystem where
            a vibrant array of products converge
          ...
          <div className="bento-tilt_2">
            <div className="relative flex size-full flex-col justify-between bg-violet-300 p-5">
              ...
              <img 
                ...
                className="absolute right-0 bottom-0 object-cover object-center w-20 h-20"
              /> */}
            </div>
          </div>
